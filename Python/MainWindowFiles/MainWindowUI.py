...
"font: 39pt \"MS Shell Dlg 2\";")
        ...
        self.pushButton = QPushButton(self.manualpage)
        ...
        self.pushButton_4 = QPushButton(self.manualpage)
        ...
        self.horizontalLayout_3.addWidget(self.pushButton_4, 0, Qt.AlignHCenter)

        self.pushButton_2 = QPushButton(self.manualpage)
        self.pushButton_2.setObjectName(u"pushButton_2")
        sizePolicy3.setHeightForWidth(self.pushButton_2.sizePolicy().hasHeightForWidth())
        self.pushButton_2.setSizePolicy(sizePolicy3)

        self.horizontalLayout_3.addWidget(self.pushButton_2, 0, Qt.AlignHCenter)
        ...
        self.pushButton_3 = QPushButton(self.manualpage)
        ...
        self.verticalLayout_7.addWidget(self.pushButton_3, 0, Qt.AlignHCenter)
        ...
        self.imageviewstack.setCurrentIndex(1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Test", None))
